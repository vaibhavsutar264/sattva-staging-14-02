              ...
              <div className="row">
                ...
                <div className="col-md-12 pl-50">
                  {this.state.showVideos ? (
                    <>
                      <h4 className="revamp-subtitle mt-3 mb-0">
                        Search result
                      </h4>
                      <div className>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-3">
                        <div className={styles.searchcards}>
                          <h1
                            onClick={this.videosFDeepestRest}
                            className="quote-writer-text black-text text-center mb-3"
                          >
                            Deepest Rest
                          </h1>
                      ...
                      <div className="col-md-3">
                        <div className={styles.searchcards}>
                          <h1
                            onClick={this.videosFPeacefulMinds}
                            className="quote-writer-text black-text text-center mb-3"
                          >
                            Peaceful Minds
                          </h1>
                      ...
                      <div className="col-md-3">
                        <div className={styles.searchcards}>
                          <h1
                            onClick={this.videosFLiveWholly}
                            className="quote-writer-text black-text text-center mb-3"
                          >
                            Live Wholly
                          </h1>
                      ...
                      <div className="col-md-3">
                        <div className={styles.searchcards}>
                          <h1
                            onClick={this.videosFAwakenShakti}
                            className="quote-writer-text black-text text-center mb-3"
                          >
                            Awaken Shakti
                          </h1>
                      ...
                      <div className="col-md-3">
                        <div className={styles.searchcards}>
                          <h1
                            onClick={this.videosFSacredSound}
                            className="quote-writer-text black-text text-center mb-3"
                          >
                            Sacred Sound
                          </h1>
                      ...
                      <div className="col-md-3">
                        <div className={styles.searchcards}>
                          <h1
                            onClick={this.videosFIlluminate}
                            className="quote-writer-text black-text text-center mb-3"
                          >
                            Illuminate
                          </h1>
                  ...
                  > */}
                    <div className="row serchVideos">
                      {this.state.allVideosCollection.mindful_movements &&
                        this.state.allVideosCollection.mindful_movements.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
                      {this.state.allVideosCollection.find_ease &&
                        this.state.allVideosCollection.find_ease.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
                      {this.state.allVideosCollection.deepest_rest &&
                        this.state.allVideosCollection.deepest_rest.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
                      {this.state.allVideosCollection.peaceful_minds &&
                        this.state.allVideosCollection.peaceful_minds.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
                      {this.state.allVideosCollection.live_wholly &&
                        this.state.allVideosCollection.live_wholly.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
                      {this.state.allVideosCollection.awaken_shakti &&
                        this.state.allVideosCollection.awaken_shakti.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
                      {this.state.allVideosCollection.breathe &&
                        this.state.allVideosCollection.breathe.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
                      {this.state.allVideosCollection.sacred_Sound &&
                        this.state.allVideosCollection.sacred_Sound.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
                      {this.state.allVideosCollection.Illuminate &&
                        this.state.allVideosCollection.Illuminate.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
                      {this.state.allVideosCollection.sya &&
                        this.state.allVideosCollection.sya.map(
                          (item, index) => {
                            return <VideoDetails item={item} key={item.id} />;
                          }
                        )}
